...
TOKEN = "347988339:AAFQSrK6x4ltdBuAjPSpcHJ8M_HQNjmsiHE"
...
def handle_updates(updates):
    ...
    for update in updates["result"]:
        ...
        #elif get_last_text(updates) is '/start' and check_departamento(text) == True:
...
# initial fixed keyboard: the three possible options NOT APPLYIED
